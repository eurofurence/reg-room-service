...
type Repository interface {
	...
	// FindGroups returns all non-soft-deleted groups satisfying the criteria.
	//
	...
	FindGroups(ctx context.Context, minOccupancy uint, maxOccupancy int, anyOfMemberID []uint) ([]*entity.Group, error)
